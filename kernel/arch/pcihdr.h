...
static const PCI_DEVTABLE PciDevTable[] = {
        ...
        {0x1000, 0x000F, "53C875, 53C876",
         "Ultra-Wide SCSI (53C876 is dual-channel)"},
        ...
        {0x1023, 0x9660, "9385",
         "Cyber 9385 Portable PC Video Controller (9660?)"},
        ...
        {0x1039, 0x0009, "SiS5595",
         "PCI System I/O Chipset (PMU configuration)"},
        ...
        {0x1078, 0x0100, "Cx5530",
         "South Bridge for Cyrixs MediaGX uProcessor"},
        ...
        {0x10B9, 0x5229, "M1543 Southbridge",
        ...
        {0x1112, 0X2340, "4 Port FEN Adapter",
         "4 10/100 UTP Fast Ethernet Adapter"},
        ...
        {0x8086, 0x0486, "82425EX",
         "PCI System Controller (PSC) for i486 (Aries)"},
        ...
        {0x8086, 0x1227, "EtherExpress PRO100",
         "10/100 Fast Ethernet Adapter Card"},
        ...
        {0x8086, 0x7180, "82443LX/EX (PAC)",
         "Host/PCI bridge in 440LX/EX AGP chipset"},
        ...
        {0x9004, 0x5078, "AVA-29xx",
         "AVA-2902I/AVA-2902E/AVA-2904/AVA-2910 SCSI Ctrlr"},
