 ...
 * The first arguments defines the output character, the second could be used to
 * pass additional arguments. In the case of kputchar is no additional argument
 * needed.
 */
...
int kprintf(const char* fmt, ...) {
    ...
    va_start(ap, fmt);
    ret = kvprintf(fmt, _putchar, /* output function */
...
int kputchar(int ch) { return vga_putchar(ch); }